...
FILES_TO_SAVE_PATH = 'files_to_save.txt'
COMMENT = '#'


def get_file_paths():
    lines = open(FILES_TO_SAVE_PATH).readlines()
...
REPOSITORY_DIRECTORY = dirname(abspath(join(sys.modules[__name__].__file__, '..'))) + os.sep
